<x-layouts>
    ...
    <x-modal.delete :action="route('admin.roles.destroy', $ModelsRole->id)" :id='$ModelsRole->id' class='my-2 flex justify-center items-center' :message="__('role.role_delete_modal')">
        @lang('role.delete')
